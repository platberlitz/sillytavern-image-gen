...
This optional SillyTavern server plugin (protocol version `0.3.0`, shipped with Quick Image Gen `3.4.0`) lets Quick Image Gen use CivitAI and Replicate when SillyTavern is running with `basicAuthMode: true`.
