...
This optional SillyTavern server plugin (protocol version `0.2.0`, shipped with Quick Image Gen `2.9.0`) lets Quick Image Gen use CivitAI and Replicate when SillyTavern is running with `basicAuthMode: true`.
