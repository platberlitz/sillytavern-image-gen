...
const SETTINGS_BOOLEAN_FIELDS = new Set([
    "enabled", "appendQuality", "useLastMessage", "useLLMPrompt", "llmEditPrompt", "llmAddQuality",
...
export function parseSettingsImport(text, options = {}) {
    ...
    if (parsed.activeSettings !== undefined) {
        ...
        result.activeSettings = normalizeImportedSettingsValues(removeImportedPrivateFields(cloned)) || {};
    }
